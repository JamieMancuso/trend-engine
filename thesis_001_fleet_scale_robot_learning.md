...
| ~~ABB~~ **REMOVED 2026-06-11** | ~~Global industrial robot installed base~~ | **Spin-off CANCELLED — operator-corrected same day.** The planned Q2 2026 pure-play listing never happened: on 2025-10-08 SoftBank signed a definitive agreement to acquire ABB's robotics business outright for $5.375B cash (≈2.3× revenue); deal closes mid-to-late 2026 pending EU/China/US regulatory approval. Post-close, ABB parent has zero robotics exposure — drop as vehicle. SoftBank (9984.T / SFTBY OTC) technically becomes the exposure route but is hopelessly diluted (Vision Fund conglomerate). **Thesis significance: this is falsification condition #4 partially firing — fleet-robotics value capture escaping public markets AGAIN (strawberry pure-plays private; ABB Robotics → private; note SoftBank also sits behind Symbotic's Exol JV). A strategic buyer paying $5.375B cash is simultaneously confirmation the asset class is valued. Watch: if regulators block the deal, the spin-off scenario could revive.** |
...
No position sizing or trade recommendation here — that's the operator's call with their own risk tolerance. Current exposure: operator holds 1 TER share @ $363.95 (Webull) — a pre-existing position that now doubles as a thesis tracker. The shadow portfolio also tracks SYM and TER (both